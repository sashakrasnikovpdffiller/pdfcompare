...
public class Comparer {
    ...
    public Comparer(InputStream pdf1, InputStream pdf2, double pageThreshold, double pixelThreshold, int kernelSize) {
        try {
            // Open pdf
            this.exportPdf1 = new PDFDocument();
            this.exportPdf1.load(pdf1);
    ...
    public boolean doComparison() {
        try {
            // Check page number
            if (this.exportPdf1.getPageCount() != this.exportPdf2.getPageCount()) {
